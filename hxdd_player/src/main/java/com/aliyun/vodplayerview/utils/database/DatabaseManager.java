...
public class DatabaseManager {
     ...
     * 数据库名称
     */
    public static final String DB_NAME = "Hxdd_Download.db";
    ...
    public int selectItemExist(AliyunDownloadMediaInfo mediaInfo) {
        Cursor cursor = mSqliteDatabase.query(TABLE_NAME, new String[]{"id"}, "new_player_id=? and quality=?",
                new String[]{mediaInfo.getNewPlayerId(), mediaInfo.getQuality()}, null, null, null);
